    ...
    <Section crosses>
      <div className='container lg:flex'>
                ...
                <li className='mb-3 py-3' key={item.id}>
                  ...
                  {item.text && (
                      <p className='body-2 mt-3 text-n-4'>
                        The pleasure of not having to worry about your books! Finished for you every month with the financial reports delivered.
                      </p>
                    )}
                </li>
              ))}
        ...
        <div className='lg:ml-auto xl:w-[38rem] mt-4'>
          ...
          lg:mx-auto'>{collabText}
          </p>
          <div className='relative left-1/2 flex w-[22rem] aspect-square border
          border-n-3 rounded-full -translate-x-1/2 scale:75 md:scale-100'>
            <div className='flex w-60 aspect-square m-auto border border-n-3
            rounded-full'>
              <div className='w-[6rem] aspect-square m-auto p-[0.2rem] bg-conic-gradient
              rounded-full'>
                <div className='flex items-center justify-center w-full h-full
                bg-n-8 rounded-full'>
                  <img className='rounded-full' src={brainwaveWhiteSymbol} 
                  width={80}
                  height={80}
                  alt='saxbookkeepers'
                  />
